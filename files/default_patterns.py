"""
Default patterns for the Quantum Code Analyzer.

This module contains pre-defined patterns for code analysis.
These patterns can be exported to YAML files for easier maintenance.
"""

# Basic improvement patterns
